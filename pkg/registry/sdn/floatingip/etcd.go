...
// NewREST returns RESTStorage objects for FloatingIPs and their /status subresource.
func NewREST(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (*registry.REST, *StatusREST, error) {
	strategy := NewStrategy(scheme)

	store := &genericregistry.Store{
		NewFunc:                   func() runtime.Object { return &sdn.FloatingIP{} },
		NewListFunc:               func() runtime.Object { return &sdn.FloatingIPList{} },
		PredicateFunc:             MatchFloatingIP,
		DefaultQualifiedResource:  sdn.Resource("floatingips"),
		SingularQualifiedResource: sdn.Resource("floatingip"),

		CreateStrategy: strategy,
		UpdateStrategy: strategy,
		DeleteStrategy: strategy,

		TableConvertor: rest.NewDefaultTableConvertor(sdn.Resource("floatingips")),
	}
...
// StatusREST implements the REST endpoint for changing the status of a FloatingIP.
type StatusREST struct {
	store *genericregistry.Store
}

// New returns an empty FloatingIP.
