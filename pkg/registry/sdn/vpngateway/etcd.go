...
// NewREST returns RESTStorage objects for VPNGateways and their /status subresource.
func NewREST(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (*registry.REST, *StatusREST, error) {
	strategy := NewStrategy(scheme)

	store := &genericregistry.Store{
		NewFunc:                   func() runtime.Object { return &sdn.VPNGateway{} },
		NewListFunc:               func() runtime.Object { return &sdn.VPNGatewayList{} },
		PredicateFunc:             MatchVPNGateway,
		DefaultQualifiedResource:  sdn.Resource("vpngateways"),
		SingularQualifiedResource: sdn.Resource("vpngateway"),

		CreateStrategy: strategy,
		UpdateStrategy: strategy,
		DeleteStrategy: strategy,

		TableConvertor: rest.NewDefaultTableConvertor(sdn.Resource("vpngateways")),
	}
...
// StatusREST implements the REST endpoint for changing the status of a VPNGateway.
type StatusREST struct {
	store *genericregistry.Store
}

// New returns an empty VPNGateway.
func (r *StatusREST) New() runtime.Object {
	return &sdn.VPNGateway{}
}
