...
// NewREST returns RESTStorage objects for HostFirewalls and their /status subresource.
func NewREST(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (*registry.REST, *StatusREST, error) {
	strategy := NewStrategy(scheme)

	store := &genericregistry.Store{
		NewFunc:                   func() runtime.Object { return &sdn.HostFirewall{} },
		NewListFunc:               func() runtime.Object { return &sdn.HostFirewallList{} },
		PredicateFunc:             MatchHostFirewall,
		DefaultQualifiedResource:  sdn.Resource("hostfirewalls"),
		SingularQualifiedResource: sdn.Resource("hostfirewall"),
...
// StatusREST implements the REST endpoint for changing the status of an HostFirewall.
type StatusREST struct {
	store *genericregistry.Store
}

// New returns an empty HostFirewall.
func (r *StatusREST) New() runtime.Object {
	return &sdn.HostFirewall{}
}
