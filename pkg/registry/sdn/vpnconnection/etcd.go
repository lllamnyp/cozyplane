...
// NewREST returns RESTStorage objects for VPNConnections and their /status subresource.
func NewREST(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (*registry.REST, *StatusREST, error) {
	strategy := NewStrategy(scheme)

	store := &genericregistry.Store{
		NewFunc:                   func() runtime.Object { return &sdn.VPNConnection{} },
		NewListFunc:               func() runtime.Object { return &sdn.VPNConnectionList{} },
		PredicateFunc:             MatchVPNConnection,
		DefaultQualifiedResource:  sdn.Resource("vpnconnections"),
		SingularQualifiedResource: sdn.Resource("vpnconnection"),

		CreateStrategy: strategy,
		UpdateStrategy: strategy,
		DeleteStrategy: strategy,

		TableConvertor: rest.NewDefaultTableConvertor(sdn.Resource("vpnconnections")),
	}
...
// StatusREST implements the REST endpoint for changing the status of a VPNConnection.
type StatusREST struct {
	store *genericregistry.Store
}

// New returns an empty VPNConnection.
func (r *StatusREST) New() runtime.Object {
	return &sdn.VPNConnection{}
}
