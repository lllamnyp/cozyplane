...
func NewREST(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (*registry.REST, *StatusREST, error) {
	...
	store := &genericregistry.Store{
		...
		NewListFunc:               func() runtime.Object { return &sdn.VPCGatewayList{} },
		PredicateFunc:             MatchVPCGateway,
		DefaultQualifiedResource:  sdn.Resource("vpcgateways"),
		SingularQualifiedResource: sdn.Resource("vpcgateway"),

		CreateStrategy: strategy,
		UpdateStrategy: strategy,
		DeleteStrategy: strategy,

		TableConvertor: rest.NewDefaultTableConvertor(sdn.Resource("vpcgateways")),
	}
...
// New returns an empty VPCGateway.
func (r *StatusREST) New() runtime.Object {
	return &sdn.VPCGateway{}
}
