...
// NewREST returns RESTStorage objects for ExternalPools and their /status subresource.
func NewREST(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (*registry.REST, *StatusREST, error) {
	strategy := NewStrategy(scheme)

	store := &genericregistry.Store{
		NewFunc:                   func() runtime.Object { return &sdn.ExternalPool{} },
		NewListFunc:               func() runtime.Object { return &sdn.ExternalPoolList{} },
		PredicateFunc:             MatchExternalPool,
		DefaultQualifiedResource:  sdn.Resource("externalpools"),
		SingularQualifiedResource: sdn.Resource("externalpool"),

		CreateStrategy: strategy,
		UpdateStrategy: strategy,
		DeleteStrategy: strategy,

		TableConvertor: rest.NewDefaultTableConvertor(sdn.Resource("externalpools")),
	}
...
// StatusREST implements the REST endpoint for changing the status of an ExternalPool.
type StatusREST struct {
	store *genericregistry.Store
}

// New returns an empty ExternalPool.
func (r *StatusREST) New() runtime.Object {
	return &sdn.ExternalPool{}
}
