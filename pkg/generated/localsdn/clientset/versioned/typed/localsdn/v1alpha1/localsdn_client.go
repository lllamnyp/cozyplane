...
// LocalV1alpha1Client is used to interact with features provided by the local.sdn.cozystack.io group.
type LocalV1alpha1Client struct {
	restClient rest.Interface
}

func (c *LocalV1alpha1Client) FabricIPs() FabricIPInterface {
	return newFabricIPs(c)
}
...
// NewForConfigAndClient creates a new LocalV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*LocalV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := localsdnv1alpha1.SchemeGroupVersion
