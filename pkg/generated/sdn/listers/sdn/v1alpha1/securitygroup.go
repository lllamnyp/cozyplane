...
type SecurityGroupLister interface {
	...
	List(selector labels.Selector) (ret []*sdnv1alpha1.SecurityGroup, err error)
...
type securityGroupLister struct {
	listers.ResourceIndexer[*sdnv1alpha1.SecurityGroup]
}
...
func NewSecurityGroupLister(indexer cache.Indexer) SecurityGroupLister {
	return &securityGroupLister{listers.New[*sdnv1alpha1.SecurityGroup](indexer, sdnv1alpha1.Resource("securitygroup"))}
}

// SecurityGroups returns an object that can list and get SecurityGroups.
func (s *securityGroupLister) SecurityGroups(namespace string) SecurityGroupNamespaceLister {
	return securityGroupNamespaceLister{listers.NewNamespaced[*sdnv1alpha1.SecurityGroup](s.ResourceIndexer, namespace)}
}
...
type SecurityGroupNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*sdnv1alpha1.SecurityGroup, error)
