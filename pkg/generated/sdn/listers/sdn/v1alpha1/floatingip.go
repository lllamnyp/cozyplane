...
type FloatingIPLister interface {
	...
	List(selector labels.Selector) (ret []*sdnv1alpha1.FloatingIP, err error)
...
type floatingIPLister struct {
	listers.ResourceIndexer[*sdnv1alpha1.FloatingIP]
}

// NewFloatingIPLister returns a new FloatingIPLister.
func NewFloatingIPLister(indexer cache.Indexer) FloatingIPLister {
	return &floatingIPLister{listers.New[*sdnv1alpha1.FloatingIP](indexer, sdnv1alpha1.Resource("floatingip"))}
}

// FloatingIPs returns an object that can list and get FloatingIPs.
func (s *floatingIPLister) FloatingIPs(namespace string) FloatingIPNamespaceLister {
	return floatingIPNamespaceLister{listers.NewNamespaced[*sdnv1alpha1.FloatingIP](s.ResourceIndexer, namespace)}
}
...
type FloatingIPNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*sdnv1alpha1.FloatingIP, error)
