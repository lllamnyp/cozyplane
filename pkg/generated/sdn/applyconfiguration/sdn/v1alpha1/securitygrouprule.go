...
type SecurityGroupRuleApplyConfiguration struct {
	...
	From *SecurityGroupPeerApplyConfiguration `json:"from,omitempty"`
...
func (b *SecurityGroupRuleApplyConfiguration) WithFrom(value *SecurityGroupPeerApplyConfiguration) *SecurityGroupRuleApplyConfiguration {
	b.From = value
	return b
}
...
func (b *SecurityGroupRuleApplyConfiguration) WithPorts(values ...*SecurityGroupPortApplyConfiguration) *SecurityGroupRuleApplyConfiguration {
	for i := range values {
		if values[i] == nil {
