...
type FloatingIPInformer interface {
	...
	Lister() sdnv1alpha1.FloatingIPLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SdnV1alpha1().FloatingIPs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SdnV1alpha1().FloatingIPs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SdnV1alpha1().FloatingIPs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SdnV1alpha1().FloatingIPs(namespace).Watch(ctx, options)
			},
		}, client),
		&apisdnv1alpha1.FloatingIP{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *floatingIPInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdnv1alpha1.FloatingIP{}, f.defaultInformer)
}

func (f *floatingIPInformer) Lister() sdnv1alpha1.FloatingIPLister {
	return sdnv1alpha1.NewFloatingIPLister(f.Informer().GetIndexer())
}
